...
<table class="table-metal-base">
    ...
    <tbody>
      <tr>
        ...
        <!-- Esses campos abaixo são para o segundo metal base, caso ele exista  -->
        <!-- Se não existir esses campos não devem ser mostrados  -->
      ...
      <tr>
        ...
        <td colspan="4">CHANFRO: <b>1,5 a 10,mm </b></td>
        <td colspan="4">ÂNGULO: <b>TODAS</b></td>
      </tr>
      <!-- Se for tubo -->
      <tr>        
        <td colspan="4">FAIXA DE DIÂMETRO TUBOS</td>
        <td colspan="4">CHANFRO: <b>1,5 a 10,mm </b></td>
        <td colspan="4">ÂNGULO: <b>angulo</b></td>
      </tr>
      <!-- Se for chapa -->
      <tr>        
        <td colspan="4">ESPESSUDA DA CHAPA</td>
        <td colspan="4">ESPESSURA(?) mm </td>
        <td colspan="4">ÂNGULO: <b>angulo</b></td>
      </tr>
