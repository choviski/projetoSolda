...
@section('content')
    ...
    <div class="col-12 p-0 bg-white text-center d-md-flex shadow-sm rounded-bottom">
        <div class="col-md-6 col-sm-12 border p-2 ativo" id="info_option" style="font-size: 16px; cursor: pointer" onclick="mostrarInfo()">
            <span style="position: relative">INFORMAÇÕES               
            </span>
        </div>
        <div class="col-md-6 col-sm-12 border p-2" id="login_option" style="font-size: 16px; cursor: pointer" onclick="mostrarLogins()">
    ...
    <div id="form_info" class="bloco_ativo">
        <div class="row col-12 d-flex justify-content-center ">
            <form class="col-md-9 col-sm-12 p-0 mt-3"action="{{Route('salvarUsuario',['id'=> $empresa->id])}}" method="post">
                @csrf
                @method('PUT')
                <div class="form-group bg-light p-2 rounded">
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <input type="text" class="form-control col" id="nome_fantasia" value="{{$empresa->nome_fantasia}}" name="nome_fantasia" required>
                        </div>
                    </div>
