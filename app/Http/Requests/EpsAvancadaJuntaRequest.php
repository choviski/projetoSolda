...
class EpsAvancadaJuntaRequest extends FormRequest
{
    ...
    public function messages(){
        return[
            ...
            'possui_cobre_junta.integer' => "O campo 'Necessidade de cobre junta?' deve conter texto.",
            ...
            'retentores.integer' => "O campo 'Retentores' deve conter texto.",
            'necessidade_remocao_cobre_junta.required' => "O campo 'Precisa remoção cobre junta?' não pode ser nulo.",
            'necessidade_remocao_cobre_junta.integer' => "O campo 'Precisa remoção cobre junta?' deve conter texto.",
            'necessidade_remocao_retentor.required' => "O campo 'Precisa remoção de retentor?' não pode ser nulo.",
            'necessidade_remocao_retentor.integer' => "O campo 'Precisa remoção de retentor?' deve conter texto.", 
