...
class EmpresaController extends Controller
{
    ...
    public function destroy(Request $request)
    {
        ...
        Usuario::where('empresa_id',$empresa->id)->forceDelete();
        Empresa::find($empresa->id)->forceDelete();
        Endereco::where('id',$empresa->endereco_id)->forceDelete();
    ...
    public function salvarUsuario($id, Request $request)
    {
        ...
        $empresa->id_inspetor = $request->id_inspetor;
        $usuarioEmpresa = Usuario::where('id_empresa',$empresa->id)->where('tipo',2)->first();
