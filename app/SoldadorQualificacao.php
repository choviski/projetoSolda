...
class SoldadorQualificacao extends Model
{
    ...
    protected $fillable=["id_soldador","cod_rqs","id_qualificacao","data_qualificacao", "validade_qualificacao","lancamento_qualificacao","nome_certificado","caminho_certificado"];
